package org.parttio.it;

import org.parttio.BasicUsageUI;
...
public class LeaderLineIT {
    ...
    public void testClearableCheckBox() {
        String rootUrl = "http://localhost:" + port + "/" + BasicUsageUI.class.getSimpleName().toLowerCase();
